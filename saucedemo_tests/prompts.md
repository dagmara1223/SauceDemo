...
finalize payments? We also have hamburger left-slide as feature, we can sort the products by the Name or Price, and I also think that there is a trap with 
login usernames, like: *locked_out_user*."    
